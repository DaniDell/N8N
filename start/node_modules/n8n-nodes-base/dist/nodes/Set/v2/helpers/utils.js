...
const configureFieldHelper = (dotNotation) => {
    if (dotNotation !== false) {
        ...
        return {
            set: (item, key, value) => {
                item[(0, utilities_1.sanitazeDataPathKey)(item, key)] = value;
            },
            get: (item, key) => {
                return item[(0, utilities_1.sanitazeDataPathKey)(item, key)];
            },
            unset: (item, key) => {
                delete item[(0, utilities_1.sanitazeDataPathKey)(item, key)];
            },
        };
    }
};
