        ...
        this.methods = {
            loadOptions: {
                async getPersonUrn() {
                    ...
                    const firstName = (_a = person.localizedFirstName) !== null && _a !== void 0 ? _a : person.given_name;
                    const lastName = (_b = person.localizedLastName) !== null && _b !== void 0 ? _b : person.family_name;
                    const name = `${firstName} ${lastName}`;
                    const returnData = [
                        {
                            name,
                            value: (_c = person.id) !== null && _c !== void 0 ? _c : person.sub,
                        },
                    ];
                    return returnData;
                },
