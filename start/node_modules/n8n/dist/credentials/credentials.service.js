...
let CredentialsService = class CredentialsService {
    constructor(credentialsRepository, sharedCredentialsRepository, ownershipService, logger, credentialsTester, externalHooks, credentialTypes, projectRepository, projectService, roleService) {
    ...
    async getMany(user, options = {}) {
        ...
        if (options.includeScopes) {
            ...
            if (((_c = (_b = options.listQueryOptions) === null || _b === void 0 ? void 0 : _b.filter) === null || _c === void 0 ? void 0 : _c.projectId) && user.hasGlobalScope('credential:list')) {
                const projectRelation = projectRelations.find((relation) => { var _a, _b; return relation.projectId === ((_b = (_a = options.listQueryOptions) === null || _a === void 0 ? void 0 : _a.filter) === null || _b === void 0 ? void 0 : _b.projectId); });
                if ((projectRelation === null || projectRelation === void 0 ? void 0 : projectRelation.role) === 'project:personalOwner') {
                    (_e = (_d = options.listQueryOptions) === null || _d === void 0 ? void 0 : _d.filter) === null || _e === void 0 ? true : delete _e.projectId;
                }
            }
        }
        if (returnAll) {
        ...
        if (typeof ((_g = (_f = options.listQueryOptions) === null || _f === void 0 ? void 0 : _f.filter) === null || _g === void 0 ? void 0 : _g.projectId) === 'string') {
            const project = await this.projectService.getProject(options.listQueryOptions.filter.projectId);
            if ((project === null || project === void 0 ? void 0 : project.type) === 'personal') {
                const currentUsersPersonalProject = await this.projectService.getPersonalProject(user);
                options.listQueryOptions.filter.projectId = currentUsersPersonalProject === null || currentUsersPersonalProject === void 0 ? void 0 : currentUsersPersonalProject.id;
            }
        }
    ...
    async transferAll(fromProjectId, toProjectId, trx) {
        trx = trx !== null && trx !== void 0 ? trx : this.credentialsRepository.manager;
        const allSharedCredentials = await trx.findBy(SharedCredentials_1.SharedCredentials, {
        ...
        await trx.insert(SharedCredentials_1.SharedCredentials, sharedCredentialsToTransfer.map((sc) => ({
            credentialsId: sc.credentialsId,
            projectId: toProjectId,
            role: sc.role,
        })));
    }
    replaceCredentialContentsForSharee(user, credential, decryptedData, mergedCredentials) {
