...
const userOnboarding_service_1 = require("../services/userOnboarding.service");
const credentials_service_1 = require("../credentials/credentials.service");
const workflow_service_ee_1 = require("./workflow.service.ee");
const workflowExecution_service_1 = require("./workflowExecution.service");
...
let WorkflowsController = class WorkflowsController {
    ...
    async getNewName(req) {
        var _a, _b;
        const requestedName = (_a = req.query.name) !== null && _a !== void 0 ? _a : config_1.default.getEnv('workflows.defaultName');
        ...
        const onboardingFlowEnabled = !config_1.default.getEnv('workflows.onboardingFlowDisabled') &&
            !((_b = req.user.settings) === null || _b === void 0 ? void 0 : _b.isOnboarded) &&
    ...
    async getWorkflow(req) {
        ...
        if (this.license.isSharingEnabled()) {
            ...
            const workflow = await this.sharedWorkflowRepository.findWorkflowForUser(workflowId, req.user, ['workflow:read'], { includeTags: !config_1.default.getEnv('workflowTagsDisabled') });
            if (!workflow) {
    ...
    async update(req) {
        ...
        let updateData = new WorkflowEntity_1.WorkflowEntity();
    ...
    async share(req) {
        ...
        await Db.transaction(async (trx) => {
            ...
            await trx.delete(SharedWorkflow_1.SharedWorkflow, {
                workflowId,
...
exports.WorkflowsController = WorkflowsController = __decorate([
    ...
    __metadata("design:paramtypes", [Logger_1.Logger,
        ...
        userOnboarding_service_1.UserOnboardingService,
