...
const SecretsHelpers = __importStar(require("../../ExternalSecrets/externalSecretsHelper.ee"));
...
class MessageEventBusDestinationWebhook extends MessageEventBusDestination_ee_1.MessageEventBusDestination {
    ...
    async matchDecryptedCredentialType(credentialType) {
        ...
        if (foundCredential) {
            const credentialsDecrypted = await ((_a = this.credentialsHelper) === null || _a === void 0 ? void 0 : _a.getDecrypted({ secretsHelpers: SecretsHelpers }, foundCredential[1], foundCredential[0], 'internal', undefined, true));
    ...
    async generateAxiosOptions() {
        ...
        if (this.credentialsHelper === undefined) {
            this.credentialsHelper = typedi_1.default.get(CredentialsHelper_1.CredentialsHelper);
        }
