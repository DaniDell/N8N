...
export declare class MessageEventBus extends EventEmitter {
    ...
    constructor(logger: Logger, executionRepository: ExecutionRepository, eventDestinationsRepository: EventDestinationsRepository, workflowRepository: WorkflowRepository, orchestrationService: OrchestrationService, recoveryService: ExecutionDataRecoveryService);
    ...
    handleRedisEventBusMessage(messageString: string): Promise<AbstractEventMessageOptions>;
