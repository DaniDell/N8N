...
export declare class AuthController {
    ...
    constructor(logger: Logger, internalHooks: InternalHooks, authService: AuthService, mfaService: MfaService, userService: UserService, license: License, userRepository: UserRepository, postHog?: PostHogClient | undefined);
